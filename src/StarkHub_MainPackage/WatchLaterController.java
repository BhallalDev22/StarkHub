...
public class WatchLaterController implements Initializable {
    ...
    public void setWatchLaterList(ObservableList<PojoToClientFlattened> watchLaterList) {
        list.setCellFactory(wllFactory -> new VideoListCell2Controller());
        list.setItems(watchLaterList);
    }
